...
are outside the scope of the MLRsearch Specification.
    ...
    TODO: Normative language. https://github.com/rfc-editor/AUTH48-rfc9971/pull/47#discussion_r3585803296
    > When that SHOULD can be safely ignored?
    When there is a risk DUT is the botgtleneck, a hope that it is not, and etst is to distinguish those.
...
the instances SHOULD contain all such additional attributes.
    ...
    TODO: Normative language. https://github.com/rfc-editor/AUTH48-rfc9971/pull/47#discussion_r3585856566
    ...
    I think my cumbersome sentences in older versions already had this "new" meaning, I have to check.
...
The value MUST be positive.
    ...
    TODO: Normative language. https://github.com/rfc-editor/AUTH48-rfc9971/pull/47#discussion_r3585865721
    > I still see this NEW deviating from the use in the main text:
    > "Certain Trials must reach this minimum.."
    > I would revert to OLD
    The difference is in irregular results.
    I could change the deffinition from unconditional should to conditional must (both lowercase).
    Let me think which will be less bad.
...
Loss Ratio, and Goal Exceed Ratio.
  ...
  Example OPTIONAL attributes are Goal Initial Trial Duration and Goal Width.
    ...
    TODO: Normative language. https://github.com/rfc-editor/AUTH48-rfc9971/pull/47#discussion_r3585881602
    > Disagree with the normative language use
    Maybe I can say those are "typical OPTIONAL" attributes?
...
Search Result unconditionally compliant with {{Section 24 of RFC2544}}.
    ...
    TODO: Normative language. https://github.com/rfc-editor/AUTH48-rfc9971/pull/47#discussion_r3585926962
