...
either elsewhere in the document.
...
some are used only for discussions purposes, for example contrasting to other terms.
...
: While the definition menions a destination interface, presumably on the tester side,
